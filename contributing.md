...
- Fixing typos.
- Improving docs.
- Checking [issues](https://github.com/search?q=user%3Aultirequiem++is%3Aopen&type=Issues).
- Reviewing [pull requests](https://github.com/search?q=user%3Aultirequiem+is%3Apr+is%3Aopen&type=Issues).
